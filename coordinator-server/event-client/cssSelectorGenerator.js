  ...
  return (function (t) {
    ...
    function (t, r, n) {
      ...
      t.exports = function (t) {
        var r,
          ...
          i,
          u = [];
        if (Array.isArray(t)) (n = []), (r = t.length - 1);
        else {
        ...
        return (
          (function n(c, a) {
            ...
            for (
              ...
              (p = c),
                o((s = Array.isArray(p) ? [].concat(p) : e(p)), t[l][f], l),
                a >= r ? u.push(s) : n(s, a + 1);
            var p;
          })(n, 0),
          u
        );
    ...
    function (t, r, n) {
      ...
      function i(t) {
        var r = t.parentNode;
        if (r)
          for (var n = 0, e = r.childNodes, i = 0; i < e.length; i++)
            if (o(e[i]) && ((n += 1), e[i] === t))
              return [':nth-child('.concat(n, ')')];
        return [];
      }
      function u(t) {
      ...
      var N = {
        ...
        nthoftype: function (t) {
          var r = S(t)[0],
            n = t.parentElement;
          if (n)
            for (var e = n.querySelectorAll(r), o = 0; o < e.length; o++)
              if (e[o] === t)
                return [''.concat(r, ':nth-of-type(').concat(o + 1, ')')];
          return [];
        },
      };
      function P(t, r) {
        if (t.parentNode)
          for (
            var n = (function (t, r) {
              ...
              e = ((u = n), (c = []).concat.apply(c, y(u))),
              o = 0;
            o < e.length;
            o++
          ) {
            var i = e[o];
            if (m(t, i, t.parentNode)) return i;
          }
        var u, c;
        return '*';
      }
